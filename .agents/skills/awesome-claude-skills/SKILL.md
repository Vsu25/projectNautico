---\nname: awesome-claude-skills\ndescription: A curated list of awesome Claude Code skills, plugins, and resources to extend agent capabilities.\n---\n\n# Awesome Claude Skills

## ðŸ“š Table of Contents  
- [Awesome Claude Skills](#awesome-claude-skills)
  - [ðŸ“š Table of Contents](#-table-of-contents)
  - [ðŸ“„ Document Skills](#-document-skills)
  - [ðŸ›  Development \& Code Tools](#-development--code-tools)
  - [ðŸ“Š Data \& Analysis](#-data--analysis)
  - [ðŸ”¬ Scientific \& Research Tools](#-scientific--research-tools)
  - [âœï¸ Writing \& Research](#ï¸-writing--research)
  - [ðŸ“˜ Learning \& Knowledge](#-learning--knowledge)
  - [ðŸŽ¬ Media \& Content](#-media--content)
  - [ðŸ¥ Health \& Life Sciences](#-health--life-sciences)
  - [ðŸ¤ Collaboration \& Project Management](#-collaboration--project-management)
  - [ðŸ›¡ Security \& Web Testing](#-security--web-testing)
  - [ðŸ”§ Utility \& Automation](#-utility--automation)
  - [ðŸ“° Articles \& Blog Posts](#-articles--blog-posts)
  - [ðŸ—‚ï¸ Collections](#ï¸-collections)
...
- [debug-skill](https://github.com/AlmogBaku/debug-skill) - Give your AI agent a real debugger â€” breakpoints, stepping, variable inspection, and stack traces via CLI.
...
- [email-html-mjml](https://github.com/framix-team/skill-email-html-mjml) - Generate responsive HTML email templates using MJML 4.x â€” cross-client compatible HTML with compilation, validation, width math, and component architecture.
...
- [Design Auditor](https://github.com/Ashutos1997/claude-design-auditor-skill) â€” Audits designs against 17 professional rules: typography, WCAG, spacing, iconography, navigation, tokens + more. Scores out of 100. Supports English & Korean.
...
- [unity-agent-skills](https://github.com/jahro-console/unity-agent-skills) - Agent skills set for AI-assisted Unity debugging â€” structured logging, runtime commands, variable watching, and more.
...
- [kaggle-skill](https://github.com/shepsci/kaggle-skill) - Complete Kaggle integration â€” account setup, competition reports, dataset/model downloads, notebook execution, submissions, and badge collection.
...
- [claude-ecom](https://github.com/takechanman1228/claude-ecom) - Generate full ecommerce business reviews from order CSVs â€” KPIs, diagnostics, and action plans.
...
- [Claude Code Video Toolkit](https://github.com/digitalsamba/claude-code-video-toolkit) â€” AI-native video production workspace for Claude Code with Remotion, ElevenLabs, FFmpeg, and Playwright skills.
- [VideoDB Skills](https://github.com/video-db/skills) - See, understand, and act on video & audio â€” ingest, search, edit, generate, and stream media via VideoDB.
- [moltdj](https://github.com/polaroteam/moltdj-skill) - AI music and podcast platform for autonomous agents â€” generate tracks, discover, earn tips and royalties.
...
## ðŸ¤ Collaboration & Project Management
...
- [sanitize](https://github.com/openclaw/skills/tree/main/skills/agentward-ai/sanitize) - Detect and redact PII from text files â€” 15 categories (SSNs, credit cards, API keys, etc.), zero dependencies, all processing local.
...
- [linkedin](https://github.com/Linked-API/linkedin-skills) - General-purpose LinkedIn automation via Linked API â€” fetch profiles, search people/companies, send messages, manage connections, create posts. Supports Sales Navigator.
...
- [hubspot-admin-skills](https://github.com/TomGranot/hubspot-admin-skills) - Skills for auditing, cleaning, enriching, and automating HubSpot CRM. Full audit â†’ plan â†’ execute â†’ maintain workflow.
...
- [devmarketing-skills](https://github.com/jonathimer/devmarketing-skills) - 33 skills for developer marketing â€” HN strategy, technical tutorials, docs-as-marketing, Reddit engagement, developer onboarding, newsletters, and SEO for devtools.
...
You can also open an **Issue** ðŸ› if you spot something that needs fixing.
